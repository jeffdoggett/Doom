...
static const unsigned char * keypatches [] =
{
  NULL,NULL,NULL,
  NULL,NULL,NULL,
...
void ST_createWidgets(void)
{
  ...
  if (plyr)
  {
    ...
    {
      int * weaponowned;
      if (i == ((int)wp_shotgun-1))
        weaponowned = &st_shotguns;
      else
        weaponowned = (int *) &plyr->weaponowned[i+1];
