...
#define BFGDELAY 1
#define OLDBFG_1FRAMES(x) {SPR_BFGG,1,BFGDELAY,A_FireOldBFG,(statenum_t)(x+S_OLDBFG1+2)},
...
#define OLDBFG_8FRAMES(x) OLDBFG_4FRAMES(x) OLDBFG_4FRAMES(x+4)
  {SPR_BFGG,0,10,A_BFGsound,(statenum_t)(S_OLDBFG1+1)},// S_OLDBFG1
  ...
  {SPR_NULL,20,5,NULL,S_PLAY_GDIE8,0,0},		// S_PLAY_GDIE7
  {SPR_NULL,21,5,NULL,S_PLAY_GDIE9,0,0},		// S_PLAY_GDIE8
  {SPR_NULL,22,-1,NULL,S_NULL,0,0}			// S_PLAY_GDIE9
};
