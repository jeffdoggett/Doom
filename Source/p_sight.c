  ...
  mobj_t*	t2 )
{
    ...
    // Ensure valid pointers - shouldn't happen but did
    // when loading a saved game using Pwad 1killtng.wad
    // 25/10/98 JAD.
    // I think that I saved the game just as the Arch Vile
    // was launching a Fire attack since that's the first
    // thing that I heard after a sucessful load.
