...
//
extern  boolean	nomonsters1;	// checkparm of -nomonsters
extern  boolean	nomonsters2;	// checkparm of -nomonsters
...
extern int snd_AllowMusic;     // Whether to play music at all
...
// File handling stuff.
extern	char		basedefaultdir[1024];
